...
This code is adapted from PyMFEM/examples/ex18_common.py, and is a mirror of 
its cpp version located at libROM/examples/dmd/dg_euler.hpp.

Original description from ex18_common.py is listed below:
