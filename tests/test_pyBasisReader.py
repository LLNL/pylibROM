...
def test_getSpatialBasis():
    ...
    assert(np.array_equal(spatial_basis1.getData(),[[-0.2672612419124243], [-0.5345224838248487], [-0.8017837257372731], [-4.4e-323]]))  

    spatial_basis2 = basis_reader.getSpatialBasis(0.5, 1)
    assert(np.array_equal(spatial_basis2.getData(), [[-0.2672612419124243], [-0.5345224838248487], [-0.8017837257372731], [-4.4e-323]]))

    spatial_basis3 = basis_reader.getSpatialBasis(0.5, 1, 1)
    assert(np.array_equal(spatial_basis3.getData(), [[-0.2672612419124243], [-0.5345224838248487], [-0.8017837257372731], [-4.4e-323]])) 
